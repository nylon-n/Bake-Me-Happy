...
One Slice at a Time</h3>
  <a href="menu.php" class="btn-order-here animate__animated animate__fadeInUp scrollto">Order Here</a>
</div>
            </div>
          </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-buttons">
                        <a href="#" class="btn btn-outline-dark" data-toggle="modal" data-target="#loginModal">Add to cart</a>
                    </div>
                    </div>
                </div>
                </div>
